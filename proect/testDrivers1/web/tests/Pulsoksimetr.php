...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES['photo2']['tmp_name'], $imagePath)) {
      ...
      $sql = "INSERT INTO Passed_PulseOximetry (TestID, DriverID, DateTimeCompleted, PulseRate, BloodOxygenSaturation, ResultPhoto) 
              VALUES (?, ?, NOW(), ?, ?, ?)";
...
<body>
  <div class="container mt-5">
    <h1>Проверка пульса и насыщения крови кислородом</h1>
    <p>Измерьте пульс и насыщение крови кислородом и сфотографируйте результат пульоскиометра, введите данные и приложите фотографию пульсоксиометра</p>
    
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="input1">Сокращений в минуту</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="input2">Насыщение крови кислородом</label>
                    <div class="input-group">
        ...
        <div class="row">
            <div class="col-md-6 img-conteiner">
                ...
                <img src="../../img_site/9_ed67ce34a43d40c9b2beb18183858725 — копия.jpeg" class="img-fluid" alt="Left Image">
                <p>Пример фото</p>
            </div>
        </div>
